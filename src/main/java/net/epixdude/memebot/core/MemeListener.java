...
class MemeListener implements ConnectionListener {
     ...
     * when the bot should try to disconnect from the voice channel. When the bot
     * tries to disconnect from the voice channel before being connected, the bot
     * becomes stuck in the voice channel.
     * 
     * @param arg0
     */
    @Override
